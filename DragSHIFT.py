...
while run:
    ...
    if player.x >= verified_dist or done2 == True:
        if already_win == False:
            ...
            already_win = True
    if key == 1:
        true_spd = pygame.font.SysFont('freesansbold.tff', 25).render("Press 1 | Ingame Speed: " + str(speed), 1, (255, 0, 0))
    if key == 2:
        true_spd = pygame.font.SysFont('freesansbold.tff', 25).render("Press 0 | Ingame Speed: " + str(speed), 1, (255, 0, 0)) 
